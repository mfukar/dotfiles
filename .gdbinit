...
#
# MAC OS X NOTES: If you are using this on Mac OS X or iOS, you must either attach gdb to a process
...
set $ARM = 0
# set to 1 to enable 64bits target by default
set $64BITS = 1
...
#
#   The end of this section contains additional options for C++.
#
...
document pstring
    ...
    Example:
    pstring s - Prints content, length, capacity and ref-count of string s
end
